...
\begin{figure}
  ...
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \caption{A visual depiction of the pseudoscalar mesons in the Eightfold Way, which form an octet and a singlet in $\text{SU}(3)$ flavour space. The horizontal axis represents $I_3$, an isospin component, and the vertical axis represents $Y$, the hypercharge, both of which are quantum numbers arising from the $\text{SU}(3)$ flavour symmetry. Figure taken from \cite{thomson_modern_2013}.}
...
The most important particle colliders for experimental QCD are typically proton-proton ($pp$) colliders, also called hadron colliders. The first hadron collider was the Intersecting Storage Rings (ISR) at CERN, which were operational from 1971, with a centre-of-mass energy of \qty{62}{\giga\electronvolt} \cite{hubner_design_2012,erhan_hyperon_1979,navas_review_2024}. It was succeeded by the Tevatron which, as suggested by its name, reached centre-of-mass energies of \qty{1}{\tera\electronvolt} \cite{noauthor_design_1980}. Notable discoveries such as that of the top quark were made by the Tevatron \cite{d0_collaboration_observation_1995,cdf_collaboration_observation_1995}. Currently, the largest hadron collider is the creatively named Large Hadron Collider (LHC) described above, which was operational from 2008 and is responsible for the monumental discovery of the Higgs boson in 2012 \cite{evans_lhc_2008,aad_observation_2012}. An image of the Compact Muon Solenoid (CMS) detector, one of the particle detectors in the LHC, is shown in Figure \ref{fig:cms}.

...
\begin{algorithm}
  ...
  \begin{algorithmic}
    \Procedure{FinalTwoAccordion}{$\texttt{event}, \text{newHadronNeeded}, \text{fromPos}, q_{+\text{end}}, q_{-\text{end}}, q_{+\text{break}}, q_{-\text{break}}, \text{species}, m, \vec{p}_\perp, z_{\pm,\text{last}}, m_{\pm,\text{last}}$}
      ...
      \EndIf
      \State $\vec{p}_{\perp,\pm} \gets \vec{p}_{\perp,\pm\text{end}} + \vec{p}_{\perp,\pm\text{break}}$
      \Repeat
        \State $\text{species}_- \gets \textsc{Combine}(\text{flav}_{-\text{end}}, \text{flav}_{-\text{break}})$
        \State $m_- \gets \textsc{mSel}(\text{species}_-)$
      \Until {\textsc{Combine} succeeds}
      \State $m_{\perp,\pm} \gets \sqrt{m_\pm^2 + |\vec{p}_{\perp,\pm}|^2}$
      \State $z_\pm \gets \textsc{zSel}(\text{flav}_{\pm,\text{end}}, \text{flav}_{\pm,\text{break}}, m_{\perp,\pm})$
      \State $\Delta y_\pm \gets -\ln\Bigr( \frac{z_{\pm}}{z_{\pm,\text{last}}} \frac{m_{\pm,\text{last}}}{m_\pm} (1 - z_{\pm,\text{last}}) \Bigr)$

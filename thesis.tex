...
\begin{enumerate}
\item Introduce the probRevertFinal parameter and the pseudocode. Explain how the algorithm works and what is changed. Include formulas for conditional spin switching.

...
I would also like to thank, in no particular order, hypomania, Lily Allen, dielectical behavioural therapy, schema therapy, my parents, somatic therapy, the adrenaline molecule, the entire physics/astrophysics honours cohort, the \textit{Geist der Tiefe}, the ethanol fermentation process, the estradiol valerate molecule, Tyler James Robinson, the voices in my head, the caffeine molecule, the character Phosphophyllite from acclaimed manga/anime Land of the Lustrous, Fiona Apple, catastrophic nervous system dysregulation, Carl Jung, emacs, the State Library of Victoria, the psychological process of identification, Instagram reels, my journal, and my superego for their various contributions (both beneficial and detrimental) to the overall stability and coherence of my psyche in this trying time. It is a tremendous relief to have had such a support network in place through the various reformulations of my self-concept that have been made necessary as a result of the continual assault on my already-fragile soul over the past nine months. I look forward to my imminent undoing during my PhD in the coming years.

Finally, I would like to take this opportunity to condemn Andy Casey.
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includesvg[width=\linewidth]{figures/dNdy_accordion_stringmasses.svg}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includesvg[width=\linewidth]{figures/dNdy_accordion_differenttunes.svg}
...
\begin{figure}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includesvg[width=\linewidth]{figures/dNdy_species_accordion.svg}
    \caption{uhh}
...
\begin{figure}
  \centering
  \includesvg[width=0.7\linewidth]{figures/deltay_compare_accordion.svg}
...
It is also worth mentioning the effect of the accordion join on the $z$ fractions, calculated from the final set of hadrons. For the default PYTHIA implementation of string fragmentation, the $z$ fractions are identical for regular hadrons, and significantly different for the final hadrons selected before the joining step, as shown in Figure (((REF))). This is expected, since in this algorithm the $z$ fractions are identically selected for all regular hadrons and are not adjusted afterwards --- the final two hadrons are then selected with different kinematics, causing the deviation in the final $z$ fractions.
